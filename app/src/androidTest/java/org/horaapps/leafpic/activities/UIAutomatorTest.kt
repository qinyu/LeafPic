...
class UIAutomatorTest {
    ...
    fun should_sort_albums_by_different_mode() {
        ...
        uiDevice.wait(Until.hasObject(By.text("LeafPic (debug)")), 10000)
        ...
        //        uiDevice.findObject(By.descContains("Open navigation drawer")).click();
        //        uiDevice.wait(Until.hasObject(By.text("Settings")),
        //                5000);
        //
